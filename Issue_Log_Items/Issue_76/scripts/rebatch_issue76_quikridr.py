"""Headless quikmstr + quikridr rebatch for Issue #76."""
import os
import sys
...
jobs = [
    ("quikmstr", ppolc_path, os.path.join(cfg_dir, "Sync_Rulebook_quikmstr.csv")),
    ("quikridr", ppben, os.path.join(cfg_dir, "Sync_Rulebook_quikridr.csv")),
]

print("=== ISSUE #76 QUIKMSTR+QUIKRIDR REBATCH START ===", flush=True)
...
try:
    ...
    log_path = os.path.join(MIG, "Logs", "_issue76_quikmstr_quikridr_rebatch_log.txt")
...
print("=== ISSUE #76 REBATCH DONE ===", flush=True)
