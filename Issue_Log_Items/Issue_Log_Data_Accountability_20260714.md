...
| GAP (not confirmed) | 10 |
| SKIP (no validator) | 0 |

## Verdict

**ATTENTION — 10 GAP(s)** must be reviewed before training.
...
| #54 | **GAP** | 209, '3': 264, '4': 2569, '2': 37} / OK: MBENTYP=8 preserved (3657 rows) / OK: loan-history policies=665 / OK: no MBENTYP=20 rows (deferred) / OK: MDATE YYYYMMD |
...
| #76 | **GAP** | validate_issue76_eti_rpu_payup v2.0 /   valuation date: 2026-07-25 (system date) /   candidates=400 payup_fail=0 mlast_fail=165 / FAIL: /   - MLASTANN mismatch: |
...
| #45 | **IN_DATA** | MBANKNO populated=2706 |
| #75 | **IN_DATA** | draft MBANKNO filled=2081/2132 invalid=0; 9010161748C=091303855/0000002000581 |
...
| #54 | **IN_DATA** | quikbenh=43589 types={'11': 14156, '12': 19135, '10': 3562, '8': 3657, '1': 209, '3': 264, '4': 2569, '2': 37} |
