...
**Generated:** 2026-07-28T07:23:27  
**Engine batch:** v57.85 full UAT Output  
**Script:** `tools/validators/validate_issue_log_accountability.py` v1.3

## Roll-up

| Status | Count |
|--------|------:|
| IN_DATA (confirmed in Output) | 40 |
| WARN (env / known caveat) | 13 |
| GAP (not confirmed) | 14 |
| SKIP (no validator) | 0 |

## Verdict

**ATTENTION — 14 GAP(s)** must be reviewed before training.
...
| #50 | **WARN** | 010335038C len: 0 / ------------------------------------------------------------------------ / WARNINGS /   WARN: Batch quikmemo.csv missing 018495BC /   WARN:  |
| #51 | **IN_DATA** | validator PASS |
| #54 | **GAP** | NTYP=20 rows (deferred) / OK: MDATE YYYYMMDD format / WARN: Estimated opening seeds (type10 - 3562 PACTG)=-166; expected 550–565 / WARN: No loan rows for sample |
...
| #60 | **GAP** | ate_issue60_pua_phase.py 2.0 / PUA rows checked: 494 (NFO-terminated: 27) / Other later-phase rows checked: 1357 / Baseline drift vs v57.85: date/age/status=86  |
| #72 | **IN_DATA** | validator PASS |
| #75 | **IN_DATA** | validator PASS |
| #76 | **GAP** | validate_issue76_eti_rpu_payup v2.0 /   valuation date: 2025-12-31 (QLA_VALUATION_DATE=20251231) /   candidates=314 payup_fail=0 mlast_fail=172 / FAIL: /   - ML |
| #110 | **IN_DATA** | validator PASS |
| #114 | **GAP** | ormatted to 2 decimals / OK: at most one 20171231 conversion adjustment per policy (579 policies) / OK: dividend-history policies=586 / ------------------------ |
...
| #21F | **WARN** | =============================================================== /  / quikprmh rows: 201574 /   schema order: PASS /  / [Golden] 010310404C CONV_ADJ rows: 0 /  / |
| #21A | **WARN** | validator blocked on missing dated extract (environmental) |
| #21J | **WARN** | cted 50.0000, got 0 /   quikplan 10L172 QTRL: expected 25.0035, got 0 /   quikplan 10L172 MTHD: expected 8.3298, got 0 /   quikplan 10L172 MTHB: expected 8.3298 |
...
| #38 | **IN_DATA** | quikdvdp MDEPOSIT non-zero=59/5084 |
...
| #50 | **IN_DATA** | memo rows=5084; sample hits={'018495BC': True, '01159D276C': True, '01ML8522C': True, '010335038C': True} |
| #51 | **IN_DATA** | QuikAint plans=['A60MIR', 'A96DAR'] |
| #54 | **IN_DATA** | quikbenh=42532 types={'1': 201, '3': 257, '6': 822, '7': 25, '4': 2489, '11': 13479, '12': 18171, '10': 3396, '2': 35, '8': 3657} |
...
| #105 | **IN_DATA** | MPAR=1 rows=2895; mismatches vs plan PAR=0; unresolvable non-PUA plans=0 |
