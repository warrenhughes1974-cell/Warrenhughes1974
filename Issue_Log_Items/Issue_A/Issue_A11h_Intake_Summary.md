# Issue A11h — Intake Summary

**Issue ID:** A11h (correction sub-package of Internal Issue A / A11)  
...
| Field / table | Observed | Expected under locked A11h |
|---------------|----------|----------------------------|
...
| Location | Behavior conflicting with A11h |
|----------|--------------------------------|
...
| Issue #77 historical lock | Explicitly allowed Band-on-presence and STVARYGP-on-GP-presence — **superseded** by A11h for Band/State |
...
See `Issue_A11h_Locked_Acceptance_Criteria.md` (Warren + Luna locked).
