...
#              v57.55 — Version sync with root app.py; Issue #40 rate emit via qla_core.rate_emit.
#              v57.54 — Issue #40: rate emit integrated in-app (QuikCvs/QuikPlCv/member tables).
    ...
    def _apply_issue85_claim_header_structure(self, output_dir):
        ...
        try:
            ...
            if merge_drops <= 0 and rephase_moves <= 0:
                # Still write payee phase fixes if any
                payee_moves = int(
                                    ...
                                    try:
                                        ...
                                        if not os.path.isfile(_prov_path):
                                            _prov_path = os.path.normpath(os.path.join(
                                                ...
                                                "Reports", "quikmstr_phase1_inherit_mstatus.csv",
                                            ))
