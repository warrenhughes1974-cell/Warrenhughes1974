...
# Version:     v57.0
# Date:        2026-05-29
# Change Note: PAAGERAT PR attained-age QuikGps (VARGP=3); SEQ->AGE, CNTL=00/GP0
# =============================================================================
...
from qla_core import plan_source_paths as _plan_paths
from qla_core.paagerat_pr_loader import load_paagerat_vargp3_plan_set_from_config
...
class QLAdminEnterpriseIntegrationSuite:
    def __init__(self, root):
        self.root = root
        self.root.title("QLAdmin Enterprise Data Integration Suite v57.0")
    ...
    def setup_ui(self):
        ...
        tk.Label(header, text="ENTERPRISE DATA INTEGRATION ENGINE v57.0", font=("Segoe UI", 20, "bold"), bg=self.bg_main, fg=self.accent).pack()
    ...
    def process_data(self, is_batch):
        try:
            ...
            self.log("Initializing Migration Engine v57.0...")
            ...
            for t_id in tables:
                ...
                if t_id.lower() == "quikplan":
                    ...
                    vargp3_plans = load_paagerat_vargp3_plan_set_from_config(
                        self._app_base_dir(), _plan_paths.paagerat_rate_paths(),
                    )
