...
KEY_CV = CFIC_ROOT / "Output" / "rates" / "QuikPlCv.csv"
KEY_TV = CFIC_ROOT / "Output" / "rates" / "QuikPlTv.csv"
OUT = CFIC_ROOT / "Issue_Log" / "CFIC_Issue_03" / "business_inputs" / "cfic_rate_key_assumptions.csv"
