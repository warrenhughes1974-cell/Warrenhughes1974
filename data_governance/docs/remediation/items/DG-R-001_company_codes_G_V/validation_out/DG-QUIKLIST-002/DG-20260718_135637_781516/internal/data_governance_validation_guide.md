...
| Run date and time | July 18, 2026 at 1:56:37 PM |
| Data-region path | `Q:\CSO\CSO_Test_6_30_2025` |
| Output path | `c:\Users\warren\Documents\GitHub\Warrenhughes1974\data_governance\docs\remediation\items\DG-R-001_company_codes_G_V\validation_out\DG-QUIKLIST-002\DG-20260718_135637_781516` |
...
**Technical name:** Validate QuikList Company Reference

**Purpose:**

Ensure every company code assigned to a QuikList group is defined in QuikComp.
...
Every nonblank normalized QuikList.MCOMP must match exactly one normalized QuikComp.MCOMP. Reuses shared QuikComp company-code index / normalization.
