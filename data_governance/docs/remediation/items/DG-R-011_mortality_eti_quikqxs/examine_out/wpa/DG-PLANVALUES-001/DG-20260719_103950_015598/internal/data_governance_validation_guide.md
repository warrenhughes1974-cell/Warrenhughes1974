...
| Run date and time | July 19, 2026 at 10:39:50 AM |
| Data-region path | `Q:\WPA\WPA_GABIE` |
| Output path | `C:\Users\warren\Documents\GitHub\Warrenhughes1974\data_governance\docs\remediation\items\DG-R-011_mortality_eti_quikqxs\examine_out\wpa\DG-PLANVALUES-001\DG-20260719_103950_015598` |
...
**Technical name:** Validate Plan Value Mortality Table Reference

**Purpose:**

Ensure every populated normalized MORT value on applicable plan-value tables exists exactly once in QuikQxs.
...
`{"QuikPlCv": {"failed": 16, "not_run": 0, "not_run_reason": "", "passed": 471, "reviewed": 487}, "QuikPlDb": {"failed": 0, "not_run": 1, "not_run_reason": "QuikPlDb does not contain field MORT.", "passed": 0, "reviewed": 0}, "QuikPlDv": {"failed": 0, "not_run": 1, "not_run_reason": "QuikPlDv does not contain field MORT.", "passed": 0, "reviewed": 0}, "QuikPlGp": {"failed": 0, "not_run": 1, "not_run_reason": "QuikPlGp does not contain field MORT.", "passed": 0, "reviewed": 0}, "QuikPlTv": {"failed": 0, "not_run": 0, "not_run_reason": "", "passed": 944, "reviewed": 944}}`

**Exact validation performed:**

Source field MORT C(2) on QuikPlCv and QuikPlTv (verified). After trim-only normalization preserving leading zeros, each nonblank MORT must match exactly one QuikQxs.MORT. Null and blank fail. Other plan-value tables without MORT are NOT_RUN for this rule. Does not confirm actuarial appropriateness.
...
- This rule confirms that the mortality-table code exists in QuikQxs. It does not confirm that the mortality table is actuarially appropriate for the plan.
