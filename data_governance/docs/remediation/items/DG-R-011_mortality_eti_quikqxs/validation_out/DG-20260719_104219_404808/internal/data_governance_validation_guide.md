...
| Run date and time | July 19, 2026 at 10:42:19 AM |
| Data-region path | `Q:\CSO\CSO_Test_6_30_2026` |
| Output path | `c:\Users\warren\Documents\GitHub\Warrenhughes1974\data_governance\docs\remediation\items\DG-R-011_mortality_eti_quikqxs\validation_out\DG-20260719_104219_404808` |
...
Ensure every populated normalized MORT value on applicable plan-value tables exists exactly once in QuikQxs. Blank and null MORT are skipped (DG-R-011).
...
`{"QuikPlCv": {"failed": 0, "not_run": 0, "not_run_reason": "", "passed": 115, "reviewed": 115}, "QuikPlDb": {"failed": 0, "not_run": 1, "not_run_reason": "QuikPlDb does not contain field MORT.", "passed": 0, "reviewed": 0}, "QuikPlDv": {"failed": 0, "not_run": 1, "not_run_reason": "QuikPlDv does not contain field MORT.", "passed": 0, "reviewed": 0}, "QuikPlGp": {"failed": 0, "not_run": 1, "not_run_reason": "QuikPlGp does not contain field MORT.", "passed": 0, "reviewed": 0}, "QuikPlTv": {"failed": 0, "not_run": 0, "not_run_reason": "", "passed": 130, "reviewed": 130}}`

**Exact validation performed:**

Source field MORT C(2) on QuikPlCv and QuikPlTv (verified). After trim-only normalization preserving leading zeros, each nonblank MORT must match exactly one QuikQxs.MORT. Null and blank are skipped (optional). Other plan-value tables without MORT are NOT_RUN for this rule. Does not confirm actuarial appropriateness.
