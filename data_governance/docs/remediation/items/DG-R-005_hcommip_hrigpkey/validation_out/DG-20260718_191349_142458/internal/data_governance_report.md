...
| Run Date | July 18, 2026 at 7:13:49 PM |
...
| | |
|---|---|
| When it ran | 2026-07-18 19:13:49 |
| Run ID | DG-20260718_191349_142458 |
| Data region (full path) | `Q:\CSO\CSO_Test_6_30_2026` |
| Output folder for this run | `c:\Users\warren\Documents\GitHub\Warrenhughes1974\data_governance\docs\remediation\items\DG-R-005_hcommip_hrigpkey\validation_out\DG-20260718_191349_142458` |
...
### Check: MEDS Plan Flags Must Match the Plan Type

**Result:** PASSED — no problems found

**What we checked:** Ensure MEDS plans use required commission and rating-key settings.

Looked at **142** record(s): **142** looked fine, **0** had a problem.
