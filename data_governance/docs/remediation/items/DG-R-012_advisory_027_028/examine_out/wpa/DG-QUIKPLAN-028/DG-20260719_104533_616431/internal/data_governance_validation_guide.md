...
| | |
|---|---|
| Run ID | `DG-20260719_104533_616431` |
| Run date and time | July 19, 2026 at 10:45:33 AM |
| Data-region path | `Q:\WPA\WPA_GABIE` |
| Output path | `C:\Users\warren\Documents\GitHub\Warrenhughes1974\data_governance\docs\remediation\items\DG-R-012_advisory_027_028\examine_out\wpa\DG-QUIKPLAN-028\DG-20260719_104533_616431` |
...
**Records reviewed:** 772

**Records that looked fine:** 551
...
Annuity plans begin with A. Issue a warning when the plan is missing from QuikAint, QuikAing, QuikAexp, or QuikAinf.
