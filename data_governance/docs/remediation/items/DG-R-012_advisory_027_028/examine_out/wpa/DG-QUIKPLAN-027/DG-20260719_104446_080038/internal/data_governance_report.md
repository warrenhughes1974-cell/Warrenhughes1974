...
| Run Date | July 19, 2026 at 10:44:46 AM |
...
| | |
|---|---|
| When it ran | 2026-07-19 10:44:46 |
| Run ID | DG-20260719_104446_080038 |
| Data region (full path) | `Q:\WPA\WPA_GABIE` |
| Output folder for this run | `C:\Users\warren\Documents\GitHub\Warrenhughes1974\data_governance\docs\remediation\items\DG-R-012_advisory_027_028\examine_out\wpa\DG-QUIKPLAN-027\DG-20260719_104446_080038` |
...
### Check: Traditional Plans Should Have Required Value Tables

**Result:** PASSED — no problems found

**What we checked:** Warn when traditional plans (first character 0–8) are missing expected value and reserve tables.

Looked at **3045** record(s): **2146** looked fine, **0** had a problem.
