...
| | |
|---|---|
| Run ID | `DG-20260719_104446_080038` |
| Run date and time | July 19, 2026 at 10:44:46 AM |
| Data-region path | `Q:\WPA\WPA_GABIE` |
| Output path | `C:\Users\warren\Documents\GitHub\Warrenhughes1974\data_governance\docs\remediation\items\DG-R-012_advisory_027_028\examine_out\wpa\DG-QUIKPLAN-027\DG-20260719_104446_080038` |
...
**Technical name:** Validate Traditional Plan Value Tables

**Purpose:**

Warn when traditional plans (first character 0–8) are missing expected value and reserve tables.
...
**Records reviewed:** 3,045

**Records that looked fine:** 2,146
...
Traditional plans begin with 0–8. Issue a warning when the plan is missing from any of QuikPlCv, QuikPlTv, QuikCvs, QuikTvs, or QuikNps.
