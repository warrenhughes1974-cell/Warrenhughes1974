...
| | |
|---|---|
| Run ID | `DG-20260718_194909_547041` |
| Run date and time | July 18, 2026 at 7:49:09 PM |
| Data-region path | `Q:\CSO\CSO_Test_6_30_2026` |
| Output path | `data_governance\docs\remediation\items\DG-R-008_blank_plan_orphans\validation_out\DG-20260718_194909_547041` |
...
**Technical name:** Validate Plan Code Characters

**Purpose:**

Ensure plan codes contain only letters and numbers with no spaces or special characters.
...
Source PLAN C(6). Exactly six characters; each character must be A–Z or 0–9 after uppercase normalization. Spaces, punctuation, and special characters fail.
