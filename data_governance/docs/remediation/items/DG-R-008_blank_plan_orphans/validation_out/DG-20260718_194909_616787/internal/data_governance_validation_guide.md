...
| Run date and time | July 18, 2026 at 7:49:09 PM |
| Data-region path | `Q:\CSO\CSO_Test_6_30_2026` |
| Output path | `data_governance\docs\remediation\items\DG-R-008_blank_plan_orphans\validation_out\DG-20260718_194909_616787` |
...
**Technical name:** Validate Plan Value Plan Reference

**Purpose:**

Ensure every populated normalized PLAN value exists exactly once in QuikPlan.
...
`{"QuikPlCv": {"failed": 0, "not_run": 0, "not_run_reason": "", "passed": 229, "reviewed": 229}, "QuikPlDb": {"failed": 0, "not_run": 0, "not_run_reason": "", "passed": 209, "reviewed": 209}, "QuikPlDv": {"failed": 0, "not_run": 0, "not_run_reason": "", "passed": 209, "reviewed": 209}, "QuikPlGp": {"failed": 0, "not_run": 0, "not_run_reason": "", "passed": 281, "reviewed": 281}, "QuikPlTv": {"failed": 0, "not_run": 0, "not_run_reason": "", "passed": 279, "reviewed": 279}}`

**Exact validation performed:**

Source field PLAN C(6) on all five plan-value tables. Leading zeros preserved. Each nonblank PLAN must match exactly one QuikPlan.PLAN. Null and blank fail. Does not confirm the rate record belongs to the correct plan product.
...
- This rule confirms that the plan code exists in QuikPlan. It does not confirm that the source rate record belongs to the correct plan.
