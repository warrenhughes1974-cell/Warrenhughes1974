...
| | |
|---|---|
| Run ID | `DG-20260718_194909_884535` |
| Run date and time | July 18, 2026 at 7:49:09 PM |
| Data-region path | `Q:\CSO\CSO_Test_6_30_2026` |
| Output path | `data_governance\docs\remediation\items\DG-R-008_blank_plan_orphans\validation_out\DG-20260718_194909_884535` |
...
**Technical name:** Validate Low and High Age

**Purpose:**

Ensure plan issue ages (LOAGE/HIAGE) are readable and the low age is less than the high age. LOAGE may be any valid minimum issue age (DG-R-007: former Age-1 must-be-zero requirement removed).
...
Source LOAGE and HIAGE (QLAdmin Issue Ages — lowest and highest age for which the plan may be issued). Both must be readable numerics. LOAGE must be less than HIAGE. LOAGE is not required to be zero.
