...
| Output path | `data_governance\docs\remediation\items\DG-R-008_blank_plan_orphans\validation_out\DG-20260718_194909_294823` |
...
**Technical name:** Validate Plan Code Length

**Purpose:**

Ensure every plan code contains exactly six meaningful characters.
...
Source PLAN C(6). After trim-only normalization preserving leading zeros, each plan code must contain exactly six characters. Blank and null fail.
